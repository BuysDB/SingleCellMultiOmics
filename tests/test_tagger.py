...
class TestMultiomeTaggingNLA(unittest.TestCase):
    ...
    def test_skip_contig(self):
        write_path = './data/write_test_rg.bam'
        tm.run_multiome_tagging_cmd(f'./data/mini_nla_test.bam --no_rejects -method nla -skip_contig chr1,chrMT -o {write_path}'.split(' '))
    ...
    def test_skip_contig_invert(self):
        write_path = './data/write_test_rg.bam'
        tm.run_multiome_tagging_cmd(f'./data/mini_nla_test.bam --no_rejects -method nla -skip_contig chr2,chr3 -o {write_path}'.split(' '))
