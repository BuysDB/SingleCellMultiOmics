...
class DamID2_c8_u3_cs2(UmiBarcodeDemuxMethod):
    ...
    def demultiplex(self, records, probe=False, **kwargs):
        ...
        # Check which of the demuxexers yielded results
        ...
        if tx_tagged_records is not None and damid_tagged_records is not None:
            # Both types
            for tx_tagged_record, damnid_tagged_record in zip(tx_tagged_records, damid_tagged_records):
                tx_tagged_record.tags.update(damid_tagged_records.tags)
